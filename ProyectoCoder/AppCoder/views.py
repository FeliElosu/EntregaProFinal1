...
def agregarOutwears(request):
      ...
      if request.method == 'POST':
            ...
            miFormulario = formularioOutwear(request.POST) #aquí mellega toda la información del html
...
def agregarBottoms(request):
      ...
      if request.method == 'POST':
            ...
            miFormulario = formularioBottom(request.POST) #aquí mellega toda la información del html
...
def agregarTees(request):
      ...
      if request.method == 'POST':
            ...
            miFormulario = formularioTees(request.POST) #aquí mellega toda la información del html
